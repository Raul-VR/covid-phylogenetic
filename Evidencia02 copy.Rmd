...
vih <- read.fasta("vih.fasta")

sequences <- c(usa, india, brazil, france, germany, uk, russia, southKorea, italy, turkey, spain, vietnam, argentina, netherlands, japan, iran, australia, colombia, indonesia, poland, vih)

sequencesSize <- list(usa, india, brazil, france, germany, uk, russia, southKorea, italy, turkey, spain, vietnam, argentina, netherlands, japan, iran, australia, colombia, indonesia, poland, vih)
...
c21<-sapply(vih,bases)

countriesNames = c("E.E.U.U","India","Brasil", "Francia", "Alemania", "Reino Unido", "Rusia", "Corea del Sur", "Italia", "Turquía", "España", "Vietnam", "Argentina", "Países Bajos", "Japón", "Irán", "Australia", "Colombia", "Indonesia", "Polonia","VIH")

par(mar=c(5,4,4,8), xpd=T)
colors = viridis(21)
barplot(matrix(c(c01,c02,c03,c04,c05,c06,c07,c08,c09,c10,c11,c12,c13,c14,c15,c16,c17,c18,c19,c20,c21),nrow=21, byrow=T),
        beside=T,
